  ...
  return (
    <div>
      <div className="max-w-7x1 mx-auto px-4 py-8">
        <p className="text-2x1 font-medium mb-6 bg-linear-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden">
          Welcome, Joe Doe
        </p>
        ...
        <div className="grid-cols-2 sm: flex flex-wrap gap-4">
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <p
                  className="text-sm group-hover:scale-105 transition-all text-center"
                  style={{ color: baseColor }}
                >
                  {resume.title}
                </p>
